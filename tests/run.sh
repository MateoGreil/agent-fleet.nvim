...
specs=(roster_spec launch_spec name_spec resume_spec sessions_spec board_spec board_render_spec switch_spec lifecycle_spec actions_spec autoname_spec state_spec)
total_pass=0
total_fail=0
